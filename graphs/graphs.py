...
# off_ch_ps = [1, 1.425, 1.95, 3.295, 7.675]
# rec_ch_ps = [1, 1.425, 1.95, 3.28, 3.46]
# exp_rec_ch_ps = [1, 1.425, 1.95, 3.295, 7.675]
...
# plt.title('Carga ofrecida vs carga recibida CASO 2')
# plt.xlabel('carga ofrecida (paq/seg)')
# plt.ylabel('carga recibida (paq/seg)')
# plt.legend()
# plt.show()
# plt.savefig("carga_ofrecida_vs_carga_recibida_ALGORITMO1_CASO.png")
# plt.close()

# #Carga ofrecida vs retardo (delay average)
off_ch_ps = [1, 1.425, 1.95, 3.295, 0.895]
av_delay= [0.424711, 0.431114, 0.456779, 0.575730, 54.283676]
plt.plot(off_ch_ps, av_delay, color ='tab:pink')
plt.title('Retardo en función de la carga ofrecida CASO 1')
plt.xlabel('carga ofrecida (paq/seg)')
plt.ylabel('retardo (seg)')
plt.show()
plt.savefig("AVG_ALGORITMO1_CASO1.png")

# # CASO 1 - chequeo de buffers y quién droppea paquetesusecols = ["vectime", "vecvalue"]
